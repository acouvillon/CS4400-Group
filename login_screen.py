...
class App(object):
    def __init__(self, login_screen):
        ...
        registration_button = Button(self.f1, text="New User? Click here to register", font=("Verdana 10 underline"), fg='blue', borderwidth=0, relief='flat')
        ...
        registration_button.grid(column=6, row=6)
